  ...
  useEffect(() => {
    ...
    const fetchProperties = async () => {
      const response = await axios.get(
        `http://localhost:8000/api/propertiesUser/${id}`,
        {
          headers: {
      ...
      >
        ...
        <div className="flex md:hidden justify-between items-center p-2 px-4">
          <div className="flex items-center space-x-1">
            <Link to="/users" className="text-xl text-indigo-500">
              <IoIosArrowBack />
            </Link>
            ...
            <div className="">
              ...
              <div className="relative">
                {user?.cover ? (
                  <>
                    <img
                      className="max-h-[200px] md:max-h-[350px] w-full object-cover"
                  ...
                  {user?.image ? (
                    <>
                      <img
                        ...
                        src={`http://localhost:8000/upload/users/${user.image}`}
                        alt=""
                      />
                    </>
                  ) : (
              ...
              {/* Name & Bio */}
              <h1 className="text-center mt-10 font-bold text-xl md:text-2xl md:mt-14">
                {user.name}
              </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 md:mb-0 p-4">
