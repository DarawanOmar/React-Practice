        ...
        <div>
          ...
          <div className="flex justify-between items-center text-balck p-4">
            ...
            <div className="space-x-8 items-center font-medium text-md hidden md:flex">
              <Link to={"/malawa"} className=' hover:px-3 hover:py-1 hover:bg-black hover:rounded-lg hover:text-white duration-500'>Home</Link>
              <Link to="/profile2" className=' hover:px-3 hover:py-1 hover:bg-black hover:rounded-lg hover:text-white duration-500'>Profile</Link>
            </div>
