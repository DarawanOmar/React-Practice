...
const ListPropritesFavoraite = ({ property, id }) => {
    ...
    <div className="flex flex-col space-y-3 p-3">
        ...
        <div className="flex space-x-10 px-4">
          <div className='text-gray-400 text-sm  flex items-center space-x-1'><span className='text-orange-600'><FaBed /></span> <h1 className='flex space-x-2'>{property.bedroom}</h1> <span>Bed</span> </div>
          <div className='text-gray-400 text-sm  flex items-center space-x-1'><span className='text-orange-600'><FaBath /></span> <h1>{property.bathroom}</h1><span>Bath</span> </div>
          <div className='text-gray-400 text-sm  flex items-center space-x-1'><span className='text-orange-600'><GiCampCookingPot /></span><h1> {property.kitchen}</h1> <span>Kitchen</span></div>
        </div>
    </div>
</div>
  )
