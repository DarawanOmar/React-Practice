        ...
        {!loader ? (<>
            <div className=''>
                ...
                <div className="relative">
                    ...
                    <span className='absolute top-[50%] left-[35%] md:left-[50%] border-[6px] rounded-full border-white'>
                        {user?.image ? 
                        (<>
                            <img className='w-28 h-28 rounded-full object-cover' src={`http://localhost:8000/upload/users/${user.image}`}  alt="" />
                        </>) 
                        : (<>
